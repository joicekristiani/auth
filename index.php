...
<body>
  ...
  <div class=" container-fluid bgc-white teks-tengah " >
        <img class="margin-atas img-square" src="media/profil.jpg", height="180px">
        <h1 class="teks-tengah" >Galeriku</h1>
        
        <p  style="text-align: center;">Website ini berisikan identitas saya</p>
...
<nav class="navbar navbar-fixed-top">
  <div class="container-fluid navbar-margin"  data-example-id="nav-pills-with-dropdown">
    <div class="navbar-header">
      ...
      <img  src="media/teks.jpg" height="40px" width="80px">
    </div>
  ...
  <div class="content-sidebar col-off-4 col-lg-4 col-sm-12 col-xs-12">
    <div class="dah-sidebar">
      <div class="sidebar-content">
        ...
        <img class="table-gambar" src="media/album/1.jpg" width="400px" height="600px">
        <img class="table-gambar" src="media/album/2.jpg" width="400px" height="600px">
       <img class="table-gambar" src="media/album/3.jpg" width="400px" height="600px">
       <img class="table-gambar" src="media/album/4.jpg" width="400px" height="600px">
       <img class="table-gambar" src="media/album/5.jpg" width="400px" height="600px">
